...
<body>
	...
	<form method="post">
		...
		<div class="imgcontainer">
			<img src="/gpapi/figs/{{img7}}" alt="entry" class="avatar">
		</div>

		<div class="container">
			<label style="text-align: center;"><b>You have not successfully completed the challenge. You are not logged in. </b></label>
		</div>
